...
# main config
PLUGINSLUG="helper-lite-for-pagespeed"
CURRENTDIR=`pwd`
MAINFILE="helper-lite-for-pagespeed.php" # this should be the name of your main php file in the wordpress plugin
...
SVNUSER="seojacky" # your svn username
